...
// vars[20], ..., vars[29] -> ψ1,...,ψ10
// vars[30], ..., vars[39] -> v1,...,v10
// vars[40], ..., vars[49] -> cte1,...,cte10
// vars[50], ..., vars[59] -> eψ1,...,eψ10
// vars[60], ..., vars[68] -> δ1,...,δ9
// vars[69], ..., vars[77] -> a1,...,a9
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  // get state values into separate variables
  double x = state[0];
  double y = state[1];
  double psi = state[2];
  double v = state[3];
  ...
  // [x,y,ψ,v,cte,eψ]
  // [δ,a]
  // Our state vector has 6 elements, actuator vector has 2 elements
  ...
  // Delta upper and lower limits to [-25, 25] in radians
